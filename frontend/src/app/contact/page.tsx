          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-4 leading-7 text-gray-600">
                Get in touch with us for any inquiries about our shipping services.
              </p>
              <div className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                <div className="flex gap-x-4">
                  ...
                  <dd>Office: KK 299 St, Kigali, Rwanda</dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>Email: info@eazyshiprwanda.com</dd>
                </div>
              </div>
            </div>
